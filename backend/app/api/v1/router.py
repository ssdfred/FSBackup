...
from app.modules.backup_retention_executor.api import (
    router as backup_retention_executor_router,
)
...
from app.modules.ui_dashboard.api import router as ui_dashboard_router
...
router.include_router(backup_retention_executor_router)
